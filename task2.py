...
class IPAnalyzer:
    ...
    def compare_methods(self):
        ...
        results["Approximate"] = {"Count": approximate_count, "Time (s)": approximate_time}
...
if __name__ == "__main__":
    ...
    print(f"{'Унікальні елементи':<25}{comparison_results['Exact']['Count']:<20}{comparison_results['Approximate']['Count']:<20}")
    print(f"{'Час виконання (сек.)':<25}{comparison_results['Exact']['Time (s)']:<20.6f}{comparison_results['Approximate']['Time (s)']:<20.6f}")
